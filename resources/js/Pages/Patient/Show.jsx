...
export default function Show({ auth, patient }) {
    if (!patient) return <div className="p-10 text-center">جاري تحميل البيانات...</div>;

    return (
        <AuthenticatedLayout user={auth.user}>
            <Head title={`ملف المريض: ${patient.full_name}`} />
            ...
            <div className="py-12 bg-gray-100 min-h-screen font-sans" dir="rtl">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="bg-white border-2 border-gray-300 shadow-xl p-8 relative text-right">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 border-t pt-8 gap-5">
                        ...
                        <div className="mt-16 flex justify-between px-10">
                            <div className="text-center w-64 border-t-2 border-gray-800 pt-2">
                                ...
                                <p className="mt-4 font-serif text-lg italic">{patient.doctor_name}</p>
                            </div>
                            <div className="text-center w-64 border-t-2 border-gray-800 pt-2">
                                <p className="text-sm font-bold">اعتماد الصيدلية</p>
                                <p className="mt-4 font-serif text-lg italic">{patient.pharmacist_name}</p>
                            </div>
                        </div>
